...
export const stripeWebhook = async (req, res) => {
  ...
  try {
    event = stripe.webhooks.constructEvent(req.body, sig, endpointSecret); //req.rawBody
  } catch (err) {
  ...
  if (event.type === "checkout.session.completed") {
    ...
    try {
      ...
      console.log("✅ Course and user updated.");
    } catch (err) {
...
export const getAllPurchasedCourse = async (req, res) => {
  try {
    ...
    console.log("❌ Error in getAllPurchasedCourse:", error);
